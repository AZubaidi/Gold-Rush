...
public class InstructionsMenu extends BaseGame
{
    public void create() 
    {  
        ...
        BitmapFont uiFont = new BitmapFont(Gdx.files.internal("assets/font.fnt"));
        ...
        uiTextButtonStyle.fontColor = Color.RED;
        ...
        TextButtonStyle uiTextButtonStyle2 = new TextButtonStyle();

        uiTextButtonStyle2.font      = uiFont;
        uiTextButtonStyle2.fontColor = Color.RED;
        
        Texture upTex2 = new Texture(Gdx.files.internal("assets/ninepatch-1.png"));
        skin.add("buttonUp", new NinePatch(upTex2, 26,26,16,20));
        uiTextButtonStyle.up = skin.getDrawable("buttonUp");
        
        Texture overTex2 = new Texture(Gdx.files.internal("assets/ninepatch-2.png"));
        skin.add("buttonOver", new NinePatch(overTex2, 26,26,16,20) );
        uiTextButtonStyle.over = skin.getDrawable("buttonOver");
        uiTextButtonStyle.overFontColor = Color.YELLOW;
        
        Texture downTex2 = new Texture(Gdx.files.internal("assets/ninepatch-3.png"));
        skin.add("buttonDown", new NinePatch(downTex2, 26,26,16,20) );        
        uiTextButtonStyle.down = skin.getDrawable("buttonDown");
        uiTextButtonStyle.downFontColor = Color.YELLOW;		
